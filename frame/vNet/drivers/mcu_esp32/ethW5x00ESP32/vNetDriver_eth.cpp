...
EthernetUDP udp;										// Ethernet UDP Socket
...
/**************************************************************************/
/*!
    The ESP32 cannot be initialized at this stage, because this Init is
...
void vNet_SetAddress_M1(uint16_t addr)
{
	...
	IPAddress ip(stack.ip[0],stack.ip[1], stack.ip[2], stack.ip[3]);
	IPAddress dns(stack.gateway[0],stack.gateway[1],stack.gateway[2], stack.gateway[3]);
	IPAddress gateway(stack.gateway[0],stack.gateway[1],stack.gateway[2], stack.gateway[3]);
	IPAddress subnet(stack.subnetmask[0],stack.subnetmask[1],stack.subnetmask[2], stack.subnetmask[3]);
