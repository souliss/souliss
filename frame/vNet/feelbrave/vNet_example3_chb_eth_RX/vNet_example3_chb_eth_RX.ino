...
void setup()
{
	...
	// Set the network parameters for Media 1 (Ethernet)
	...
	vNet_SetSubnetMask(0x0000, 1);		// Set subnet mask on media 1
    vNet_SetMySuperNode(0x0011, 1);		// Set Associated SuperNode
