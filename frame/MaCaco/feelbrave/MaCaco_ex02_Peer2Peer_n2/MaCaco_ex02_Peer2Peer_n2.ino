/******************************************************************************
	MaCaco Example 2 - Peer to peer polling
	 
	In this example two devices poll data within them self, run this code on
...
{ 	  
	...
	if(abs(millis()-tmr) > 10000)
	{
		...
		// send data to node 1
		MaCaco_send(network_address1, MaCaco_READREQANA, (&MemoryMap[MaCaco_IN_s]), MaCaco_OUT_s, MaCaco_OUTLENGHT, 0x00);
	}   
}
