/**************************************************************************
	...
	Modified by Dario Cdj for Notify and Settings Functions									   
...
#define STORE__TELEGRAMBOTTOKEN_s (STORE__USERSPACE_f+1)
...
#define	STORE__NOTIFYMESSAGE_f	(STORE__NOTIFYMESSAGE_s+50)
...
#define	STORE__OTAPASSWORD_s	(STORE__NODENAME_f+1)	
#define	STORE__OTAPASSWORD_f	(STORE__OTAPASSWORD_s+64)
#define	STORE__USABLESIZE	(STORE__OTAPASSWORD_f+1)
#define	STORE__SIZE			(STORE__INDEX+STORE__USABLESIZE)

#if(DYNAMICADDRESSING)
#	define	FIRST_EEPROM_BYTE	(STORE__INDEX+STORE__OTAPASSWORD_f)
#else
