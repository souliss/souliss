...
{ 
	...
	{	
		...
		if (!(phase_fast % 3))
		{
			...
			Souliss_DigIn(2, Souliss_T1n_OnCmd, memory_map, LIGHT1_N2);
			
			// Use Pin3 as OFF command
			Souliss_DigIn(3, Souliss_T1n_OffCmd, memory_map, LIGHT1_N2);			
			
			// Execute the logic
			Souliss_Logic_T11(memory_map, LIGHT1_N2, &data_changed);

			// Use Pin9 as output on the electrical load
			Souliss_DigOut(9, Souliss_T1n_Coil, memory_map, LIGHT1_N2);			
		} 
