...
#define SOULISS_SET_OUTPUTS 	ssDigOut(OUT1, Souliss_T2n_Coil_Open,  WINDOW_BATH1);\
								ssDigOut(OUT2, Souliss_T2n_Coil_Close, WINDOW_BATH1);\
								ssDigOut(OUT3, Souliss_T2n_Coil_Open,  WINDOW_BEDROOM2);\
								ssDigOut(OUT4, Souliss_T2n_Coil_Close, WINDOW_BEDROOM2);
