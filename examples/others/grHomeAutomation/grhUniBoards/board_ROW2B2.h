...
#define SOULISS_SET_OUTPUTS 	ssDigOut(OUT1, Souliss_T2n_Coil_Open,  WINDOW_LIVING);\
								ssDigOut(OUT2, Souliss_T2n_Coil_Close, WINDOW_LIVING);\
								ssDigOut(OUT3, Souliss_T2n_Coil_Open,  WINDOW_KITCHEN);\
								ssDigOut(OUT4, Souliss_T2n_Coil_Close, WINDOW_KITCHEN);
