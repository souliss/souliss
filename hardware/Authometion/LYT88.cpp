...
U8 Souliss_Logic_LYTLamps(U8 *memory_map, U8 slot, U8 *trigger)
{
	...
	else if (memory_map[MaCaco_IN_s + slot] == Souliss_T1n_BrightUp)				// Increase the light value 
	{
		...
		{
			if(memory_map[MaCaco_OUT_s + slot + 1] < (0xF0 - BRIGHT_STEP)) memory_map[MaCaco_OUT_s + slot + 1]+=BRIGHT_STEP;
			if(memory_map[MaCaco_OUT_s + slot + 2] < (0xF0 - BRIGHT_STEP)) memory_map[MaCaco_OUT_s + slot + 2]+=BRIGHT_STEP;
			if(memory_map[MaCaco_OUT_s + slot + 3] < (0xF0 - BRIGHT_STEP)) memory_map[MaCaco_OUT_s + slot + 3]+=BRIGHT_STEP;
	...
	else if (memory_map[MaCaco_IN_s + slot] == Souliss_T1n_BrightDown)				// Decrease the light value
	{
		...
		{
			if(memory_map[MaCaco_AUXIN_s + slot] < (LYT_MaxBright-BRIGHT_STEP))	memory_map[MaCaco_AUXIN_s + slot]-=BRIGHT_STEP;		// Decrease the light value
