...
*/
/**************************************************************************/
#ifndef VNET_ETHRAW_H
#define VNET_ETHRAW_H
...
#define	ETH_FRAME_LEN			(VNET_HEADER_SIZE+VNET_MAX_PAYLOAD+ETH_HEADER_LEN+ETH_PREAMBLE_LEN+ETH_POSTAMBLE_LEN)
